...
const SEED = [
  ...
  { slug: "engage-tweet-4", kind: "social", title: "Like, comment & RT (post #4)", description: "Like, reply, and retweet this post on X. One claim.", points: 150, max: 1, payload: '{"trustBased":true,"url":"https://x.com/DogeForgefun/status/2046219388479512926"}', sort: 19 },
